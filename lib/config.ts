...
export const config = {
  ...
  // See PRD.md §6.
  tiers: {
    free: { envelopesPerMonth: 5, aiMessagesPerMonth: 10, retentionYears: 1, docsPerEnvelope: 1, addons: [] as string[] },
    starter: { envelopesPerMonth: 50, aiMessagesPerMonth: 50, retentionYears: 3, docsPerEnvelope: 3, addons: ["bulk_send"] },
    business: {
